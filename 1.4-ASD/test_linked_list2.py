...
from linked_list2 import LinkedList2
...
class TestLinkedList(TestCase):
    ...
    def test_find_all(self):
        ...
        self.assertIs(None, node1.prev)
        self.assertIs(None, node8.next)
    ...
    def test_insert(self):
        ...
        self.assertEqual(42, linked_list.tail.value)
    ...
    def test_add_in_head(self):
        ...
        self.assertEqual(node4, linked_list.head)
        self.assertEqual(node4, linked_list.tail)
        self.assertIsNone(node4.prev)
        self.assertIsNone(node4.next)

        linked_list.add_in_tail(node42)
        self.assertEqual(node4, linked_list.head)
        self.assertEqual(node42, linked_list.tail)
        self.assertEqual(node4, linked_list.tail.prev)
        self.assertEqual(node42, linked_list.head.next)
        self.assertIsNone(linked_list.head.prev)
        self.assertIsNone(linked_list.tail.next)

        linked_list.add_in_head(node50)
        self.assertEqual(node50, linked_list.head)
        self.assertEqual(node42, linked_list.tail)
        self.assertEqual(node4, linked_list.tail.prev)
