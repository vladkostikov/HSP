class HeapSort:
    def __init__(self, array: list[int]):
        ...
        self.HeapObject.MakeHeap(array, self._calculate_dapth(array))

    def GetNextMax(self) -> int:
        return self.HeapObject.GetMax()

    def _calculate_dapth(self, array: list[int]) -> int:
        number_for_calculating_depth_based_on_length = 0.34
        return int(len(array) ** number_for_calculating_depth_based_on_length) + 1
